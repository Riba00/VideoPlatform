                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="rpx-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                ...
                                @else
                                    <tr class="bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="/series/{{$serie->id}}" class="text-indigo-600 hover:text-indigo-900">Show</a>
                                            <a href="/manage/series/{{$serie->id}}" class="text-green-600 hover:text-indigo-900">Edit</a>
                                            <form class="inline" action="/manage/series/{{$serie->id}}" method="POST">
                                                @csrf
                                                @method('DELETE')

                                                <a href="/series/{{$serie->id}}" class="text-red-600 hover:text-indigo-900"
