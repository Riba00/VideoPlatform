                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mt-1">
                                                            <input required id="title" name="title" type="text"
                                                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2" value="{{ $video->title }}">
                                                        </div>
